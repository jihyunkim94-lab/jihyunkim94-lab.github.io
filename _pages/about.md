...
/* ============================================================
   News 표 정렬 — 날짜 칸 130px 고정 (News 탭과 동일 규격)
   Bootstrap 의 기본 패딩을 걷어내 날짜가 왼쪽 여백에 딱 붙게 한다
   ============================================================ */
.news table { width: 100%; margin-bottom: 0 !important; }
...
.publications .author { margin-bottom: 0.15rem !important; }
...
html[data-theme="light"] .news table td { color: #5A5A5A !important; }
...
html[data-theme="dark"] .news table th { color: #FCFCFC !important; }
html[data-theme="dark"] .news table td { color: #B0B0B0 !important; }
...
/* ===== 슬라이더 =====
   margin 첫 값(-120px)이 슬라이더 높이를 결정한다.
   더 올리려면 -140px, 내리려면 -100px                          */
.kimlab-intro::after { content: ""; display: block; clear: both; }
.kimlab-slider { float: right; width: 300px; max-width: 100%; margin: -120px 0 1.5rem 2rem; }
